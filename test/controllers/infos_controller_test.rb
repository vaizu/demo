...
class InfosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create info" do
    assert_difference('Info.count') do
      post infos_url, params: { info: { infolink: @info.infolink, infotitle: @info.infotitle } }
    end
  ...
  test "should update info" do
    patch info_url(@info), params: { info: { infolink: @info.infolink, infotitle: @info.infotitle } }
