...
class WidgetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create widget" do
    assert_difference('Widget.count') do
      post widgets_url, params: { widget: { content: @widget.content, location: @widget.location, title: @widget.title } }
    end
  ...
  test "should update widget" do
    patch widget_url(@widget), params: { widget: { content: @widget.content, location: @widget.location, title: @widget.title } }
