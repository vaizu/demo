...
class RankingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ranking" do
    assert_difference('Ranking.count') do
      post rankings_url, params: { ranking: { fifth: @ranking.fifth, first: @ranking.first, fourth: @ranking.fourth, second: @ranking.second, third: @ranking.third, title: @ranking.title } }
    end
  ...
  test "should update ranking" do
    patch ranking_url(@ranking), params: { ranking: { fifth: @ranking.fifth, first: @ranking.first, fourth: @ranking.fourth, second: @ranking.second, third: @ranking.third, title: @ranking.title } }
