class SettingsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @setting.update(setting_params)
        format.html { render :edit, notice: "Setting was successfully updated." }
  ...
  private
    ...
    def setting_params
      params.require(:setting).permit(:login_id, :login_pass, :customer_tel, :recruiting_tel, :mail, :opening, :closing, :reserve, :holiday, :nearest, :address, :business_trip, :cast_ja, :cast_en)
    end
end
