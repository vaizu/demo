class RankingsController < ApplicationController
  ...
  def show
    @first = Therapist.find(@ranking.first)
    @second = Therapist.find(@ranking.second)
    @third = Therapist.find(@ranking.third)
    @fourth = Therapist.find(@ranking.fourth)
    @fifth = Therapist.find(@ranking.fifth)
  end
  ...
  private
    ...
    def ranking_params
      params.require(:ranking).permit(:title, :first, :second, :third, :fourth, :fifth, :therapist_id)
    end
end
