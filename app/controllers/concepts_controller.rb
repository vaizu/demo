class ConceptsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @concept.update(concept_params)
        format.html { render :edit, notice: "Concept was successfully updated." }
        format.json { render :edit, status: :ok, location: @concept }
      else
  ...
  private
    ...
    def concept_params
      params.require(:concept).permit(:concept)
    end
end
